...
#define STA_SSID1              "Patrycja"                // [Ssid1] Wifi SSID
#define STA_PASS1              "511386377"                // [Password1] Wifi password
...
#define KEY_DEBOUNCE_TIME      10                // [ButtonDebounce] Number of mSeconds button press debounce time
